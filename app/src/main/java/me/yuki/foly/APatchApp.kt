...
import me.yuki.foly.ui.CrashHandleActivity
import me.yuki.foly.util.APatchCli
import me.yuki.foly.util.verifyAppSignature
...
class APApplication : Application(), Thread.UncaughtExceptionHandler, ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        me.yuki.foly.util.LauncherIconUtils.applySaved(this)
        ...
        me.yuki.foly.util.FolkApiClient.prefetch(
            "https://folk.mysqil.com/api/version"
        )

        MusicConfig.load(this)
        me.yuki.foly.ui.theme.SoundEffectConfig.load(this)
        me.yuki.foly.ui.theme.VibrationConfig.load(this)
