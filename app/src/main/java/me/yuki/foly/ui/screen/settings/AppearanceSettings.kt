...
import me.yuki.foly.ui.component.SwitchIconState
import me.yuki.foly.ui.component.FilePickerDialog

import me.yuki.foly.ui.component.SplicedColumnGroup
import me.yuki.foly.ui.component.ToggleSettingCard
import me.yuki.foly.ui.component.ThemeColorPicker
import me.yuki.foly.ui.component.ThemeMode
import me.yuki.foly.ui.component.ThemeModeSelector
...
import me.yuki.foly.ui.theme.BackgroundManager
import me.yuki.foly.ui.theme.FontConfig
                ...
                item(key = "appearance_nav_layout") {
                    ...
                    AnimatedVisibility(visible = expanded) {
                        Column(modifier = Modifier.padding(start = 16.dp, top = 8.dp)) {
                            me.yuki.foly.ui.component.CheckboxItem(
                                icon = null,
                                ...
                                if (showBannerApiConfigDialog.value) {
                                    BannerApiConfigDialog(
                                        ...
                                        onClearCache = {
                                            scope.launch {
                                                loadingDialog.show()
                                                me.yuki.foly.ui.screen.BannerApiService.clearAllCache(context)
                                                loadingDialog.hide()
