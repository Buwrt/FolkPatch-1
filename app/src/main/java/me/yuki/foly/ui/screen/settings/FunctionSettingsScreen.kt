...
import me.yuki.foly.Natives
import me.yuki.foly.R
import me.yuki.foly.ui.component.UmountConfig
import me.yuki.foly.ui.component.UmountConfigManager
import me.yuki.foly.ui.theme.BackgroundConfig
import me.yuki.foly.util.isHideServiceEnabled as checkHideServiceEnabled
import me.yuki.foly.util.isUtsSpoofEnabled as checkUtsSpoofEnabled
import me.yuki.foly.util.setUtsSpoofEnabled
import me.yuki.foly.util.writeUtsSpoofConfig
import me.yuki.foly.util.removeUtsSpoofConfig
import me.yuki.foly.util.isPathHideEnabled as checkPathHideEnabled
import me.yuki.foly.util.isPathHideUidModeEnabled as checkPathHideUidMode
import me.yuki.foly.util.isPathHideFilterSystemEnabled as checkPathHideFilterSystem
import me.yuki.foly.util.setPathHideEnabled
import me.yuki.foly.util.writePathHidePaths
import me.yuki.foly.util.readPathHidePaths
import me.yuki.foly.util.normalizePathHidePaths
import me.yuki.foly.util.isNetIsolateEnabled as checkNetIsolateEnabled
import me.yuki.foly.util.readNetIsolateUids
import me.yuki.foly.util.setNetIsolateEnabled
import me.yuki.foly.util.writeNetIsolateUids
import me.yuki.foly.util.writePathHideUids
import me.yuki.foly.util.setPathHideUidMode
import me.yuki.foly.util.setPathHideFilterSystem
import me.yuki.foly.util.ui.LocalSnackbarHost
import me.yuki.foly.util.ui.NavigationBarsSpacer
        ...
        if (kPatchReady && aPatchReady) {
            withContext(Dispatchers.IO) {
                ...
                val uidSource = Natives.pathHideUidList().ifBlank {
                    me.yuki.foly.util.readPathHideUids()
                }
