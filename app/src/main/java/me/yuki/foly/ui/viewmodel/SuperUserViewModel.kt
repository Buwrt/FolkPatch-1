package me.yuki.foly.ui.viewmodel
...
import me.yuki.foly.IAPRootService
import me.yuki.foly.Natives
import me.yuki.foly.apApp
import me.yuki.foly.services.RootServices
import me.yuki.foly.util.APatchCli
import me.yuki.foly.util.HanziToPinyin
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    me.yuki.foly.util.ui.showToast(context, me.yuki.foly.R.string.backup_success)
                }
            } catch (e: Exception) {
                Log.e(TAG, "Backup failed", e)
                withContext(Dispatchers.Main) {
                    me.yuki.foly.util.ui.showToast(context, "Backup failed: ${e.message}")
                }
            }
        }
    }
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (newConfigs.isNotEmpty()) {
                    ...
                    fetchAppList()
                    withContext(Dispatchers.Main) {
                        me.yuki.foly.util.ui.showToast(context, me.yuki.foly.R.string.restore_success)
                    }
                }
            } catch (e: Exception) {
                Log.e(TAG, "Restore failed", e)
                withContext(Dispatchers.Main) {
                    me.yuki.foly.util.ui.showToast(context, "Restore failed: ${e.message}")
                }
            }
        }
    }
