...
import me.yuki.foly.util.DownloadStatus
import me.yuki.foly.util.DownloadProgress
import me.yuki.foly.util.FolkApiClient
import me.yuki.foly.util.ThemeDownloader
...
class ThemeStoreViewModel(private val context: Context) : ViewModel() {
    ...
    fun fetchThemes() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            errorMessage = null
            try {
                val token = me.yuki.foly.Natives.getApiToken(apApp)
